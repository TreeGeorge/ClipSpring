...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='영화 구매 내역 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `buy_movie_list` VALUES (1,'2020-07-07 00:00:00','N','N',16000,1,1),(2,'2020-07-08 00:00:00','D','Y',4400,1,2),(3,'2020-09-08 00:00:00','N','Y',7000,1,3),(4,'2020-09-09 00:00:00','N','N',1000,1,4),(5,'2020-09-07 00:00:00','Y','Y',2750,1,6);
...
INSERT INTO `category_type` VALUES (1,'액션','G'),(2,'코미디','G'),(3,'드라마','G'),(4,'멜로','G'),(5,'공포/스릴러','G'),(6,'SF/판타지','G'),(7,'애니메이션','G'),(8,'다큐멘터리','G'),(100,'디즈니','C'),(101,'워너브러더스','C'),(102,'소니픽쳐서','C'),(103,'NBC 유니버셜','C'),(104,'20세기 폭스','C'),(105,'파라마운트','C'),(1000,'할인 영화관','P'),(1001,'추천 영화','P'),(1002,'최신 영화','P');
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='쿠폰과 회원을 연결해주는 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-09-09  1:59:52
