...
public class MovieCategoryJoinServiceTest {
	...
	public void testA() {
		...
		MovieCategoryJoin input = new MovieCategoryJoin();
		// 영화타입이 액션일 경우
		input.setCategory_type_no(1);
		sqlSession.selectList("MovieCateogoryJoinMapper.oneMovieCategoryJoin",input);
	}
}
